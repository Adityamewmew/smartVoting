            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                <thead class="bg-gray-50 dark:bg-neutral-800">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-400">Nama Event</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500 dark:text-neutral-400">Belum ada aktivitas voting</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
