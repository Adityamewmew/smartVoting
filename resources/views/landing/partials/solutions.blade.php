...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20" id="solutions">
    ...
    <div class="max-w-6xl mx-auto mt-12 relative text-left">
        <!-- Outer Glassmorphism Card Container -->
        <div class="bg-white rounded-[32px] border border-slate-200/90 shadow-[0_20px_50px_-15px_rgba(15,23,42,0.08)] p-5 sm:p-8 space-y-6">
